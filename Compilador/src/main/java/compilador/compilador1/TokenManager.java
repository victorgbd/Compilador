...
/* Generated By:JavaCC: Do not edit this line. TokenManager.java */
...
/** Constructor. */
public TokenManager(SimpleCharStream stream){
...
/** Constructor. */
public TokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
